...
class PrologShell:
	...
	def get_high_diseases(self):
		# Lists all diseases with 'yes' symptoms in the patient.
		return _parse_pl_list(self.query("hd."))
	...
	def get_high_symptoms(self):
		# Lists all symptoms marked as 'yes' in the patient.
		return _parse_pl_list(self.query("hs."))
	...
	def get_high_disease_symptoms(self, disease):
		# Lists of symptoms where disease resolves to 'yes'.
		return _parse_pl_list(self.query(f"hds('{disease}')."))
